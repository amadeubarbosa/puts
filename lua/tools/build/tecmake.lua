...
function run(t, arguments)
  ...
  print("[ INFO ] Compiling package via tecmake: ".. nameversion)
  ...
  if #build.mf > 0 and not t.install_files and not t.dev_files then
    util.install(nameversion, build_dir .. "../bin/".. TEC_UNAME .. "/*", INSTALL.BIN )
    util.install(nameversion, build_dir .. "../lib/".. TEC_UNAME .. "/*".. t.name .."*.so*", INSTALL.LIB )
    util.install(nameversion, build_dir .. "../lib/".. TEC_UNAME .. "/*".. t.name .."*.dylib*", INSTALL.LIB )
--    util.install(nameversion, build_dir .. "../lib/".. TEC_UNAME .. "/*".. t.name .."*.dll*", INSTALL.LIB )
    util.install(nameversion.."-dev", build_dir .. "../lib/".. TEC_UNAME .. "/*".. t.name .."*.a*", INSTALL.LIB )
    util.install(nameversion.."-dev", build_dir .. "../lib/".. TEC_UNAME .. "/*".. t.name .."*.so*", INSTALL.LIB )
    util.install(nameversion.."-dev", build_dir .. "../lib/".. TEC_UNAME .. "/*".. t.name .."*.dylib*", INSTALL.LIB )
--    util.install(nameversion.."-dev", build_dir .. "../lib/".. TEC_UNAME .. "/*".. t.name .."*.lib*", INSTALL.LIB )
--    util.install(nameversion.."-dev", build_dir .. "../lib/".. TEC_UNAME .. "/*".. t.name .."*.dll*", INSTALL.LIB )
    util.install(nameversion.."-dev", build_dir .. "../include/*", INSTALL.INC .. t.name )
  end
